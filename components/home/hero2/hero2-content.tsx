...
export function Hero2Content({ appDownloadUrl }: Hero2ContentProps) {
  return (
    <div className="flex flex-col items-center text-center lg:items-start lg:text-start">
      ...
      <h1 className="mt-5 max-w-xl text-[2.375rem] font-black leading-[1.25] tracking-[-0.01em] sm:text-[3rem] sm:leading-[1.22] lg:text-[3.5rem] lg:leading-[1.18]">
      ...
      <p className="mt-6 max-w-md text-[15px] leading-8 text-muted-foreground lg:max-w-lg">
        {HERO2_DESCRIPTION}
      </p>

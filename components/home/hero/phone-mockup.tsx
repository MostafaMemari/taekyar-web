...
export function PhoneMockup() {
  return (
    <div className="relative mx-auto w-fit">
      <span
        aria-hidden="true"
        className="absolute -end-14 top-1/2 hidden -translate-y-1/2 select-none font-black text-3xl tracking-[0.4em] text-foreground/[0.05] [writing-mode:vertical-rl] xl:block"
      >
        태권도
      </span>

...
export async function SidebarAppCta() {
  const settings = await getSiteSettings();
  const href = settings.appDownloadUrl ?? "/#download";
  const isExternal = settings.appDownloadUrl !== null;
  return (
    <section
    ...
    >
      ...
      <p className="mt-1.5 text-[11px] leading-6 text-white/75 sm:text-xs">

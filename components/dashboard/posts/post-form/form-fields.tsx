...
interface PostDetailsFieldsProps extends PostFieldsProps {
  categories: Array<{ id: number; name: string }>;
}

export function PostDetailsFields({ fields, onFieldChange, categories }: PostDetailsFieldsProps) {
  return (
...
interface PostTagsFieldsProps {
  tags: Array<{ id: number; name: string }>;
  selectedTagIds: number[];
  onToggleTag: (id: number) => void;
}

export function PostTagsFields({ tags, selectedTagIds, onToggleTag }: PostTagsFieldsProps) {
  return (
...
export function PostSeoFields({ fields, onFieldChange }: PostFieldsProps) {
  return (
    <div className="space-y-4">

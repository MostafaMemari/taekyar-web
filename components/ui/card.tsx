...
function Card({
  ...
  interactive = false,
  ...props
}: React.ComponentProps<"div"> & { asChild?: boolean; size?: "default" | "sm"; interactive?: boolean }) {

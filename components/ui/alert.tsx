  ...
  "group/alert relative grid w-full gap-0.5 rounded-lg border px-2.5 py-2 text-start text-sm has-data-[slot=alert-action]:relative has-data-[slot=alert-action]:pe-18 has-[>svg]:grid-cols-[auto_1fr] has-[>svg]:gap-x-2 *:[svg]:row-span-2 *:[svg]:translate-y-0.5 *:[svg]:text-current *:[svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        success:
          "border-belt-green/25 bg-belt-green/5 text-belt-green *:data-[slot=alert-description]:text-belt-green/90 *:[svg]:text-current",
        warning:
          "border-amber-300/70 bg-amber-50 text-amber-800 *:data-[slot=alert-description]:text-amber-800/90 *:[svg]:text-current",
      },
    },
    defaultVariants: {
      variant: "default",
